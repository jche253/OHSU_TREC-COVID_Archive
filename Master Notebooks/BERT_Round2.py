...
curr_dir = os.getcwd()
Pyserini_files = os.path.join(curr_dir, 'Round2_data')
if (os.path.exists(Pyserini_files) == False):
    os.mkdir(Pyserini_files)
R2_fulltext = r'/home/exacloud/lustre1/chianglab/chenjim/CORD19/Pyserini_Lucene_CORD_index/lucene-index-cord19-full-text-2020-05-01'
R2_Queries = r'/home/exacloud/lustre1/chianglab/chenjim/CORD19/Round2_data/Round2_QQNTokens.txt'
with open(R2_Queries, 'r') as f:
    queries = f.readlines()
full_df = pd.read_csv(r'/home/exacloud/lustre1/chianglab/chenjim/CORD19/Round2_data/time_fusion.txt', sep = ' ', header = None)
full_df.columns = ['topic', 'q0', 'docid', 'rank', 'score', 'title', 'doi', 'date', 'qid']
...
reader = JIndexReaderUtils.getReader(R2_fulltext)
...
with open(os.path.join(Pyserini_files,'paragraph_scores.pkl'), 'wb') as handle:
